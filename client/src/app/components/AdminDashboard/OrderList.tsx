...
const OrderList: React.FC<OrderListProps> = ({ orders }) => {
	...
	const handleDeleteOrder = (orderId: string) => {
		...
		setLoading(true);
		if (isConfirmed) {
			fetch(`${API_URL}/api/order/${orderId}`, {
				method: "DELETE",
				credentials: "include",
				headers: {
					...
					<MenuItem value="Pending">
						<div style={{ whiteSpace: "nowrap", display: "flex" }}>
							...
							>
								...
								<g fill="#B0BEC5">
									<path d="M37,10c-1.1,0-2,0.9-2,2v4c0,1.1,0.9,2,2,2s2-0.9,2-2v-4C39,10.9,38.1,10,37,10z"></path>
									<path d="M20,10c-1.1,0-2,0.9-2,2v4c0,1.1,0.9,2,2,2s2-0.9,2-2v-4C22,10.9,21.1,10,20,10z"></path>
								</g>
								<rect
									x="32"
									y="34"
		...
		<div className="m-5 rounded-lg pb-12">
			...
			{filteredOrders.length === 0 && !loading && (
				<Typography
					...
					sx={{ textAlign: "center" }}
				>
					No orders found based on the current filter/search criteria.
				</Typography>
			)}
			{selectedOrder && (
				<OrderDetails
