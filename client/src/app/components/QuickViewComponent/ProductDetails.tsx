...
const ProductDetails: React.FC<ProductDetailsProps> = ({ productDetails, flavor, setFlavor, addToCart, handleClose, setProductDetails, products }) => {
					...
					>
						{relatedProducts.map((product) => (
							<Box
								...
								className={styles.quickviewRelatedContainer}
								key={product._id}
							>
								{" "}
								{/* Use `_id` or appropriate key property */}
								<img
									className={styles.quickviewRelatedImg}
									alt="related"
