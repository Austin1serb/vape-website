...
module.exports = {
    ...
    createOne: async (req, res) => {
        ...
        try {
            ...
            const existingCustomer = await Users.findOne({ email });
            if (existingCustomer) {
    ...
    logoutUser: async (req, res) => {
        try {
            ...
            await Users.updateOne({ _id: decoded.customerId }, { $unset: { refreshToken: "" } });
    ...
    deleteOne: async (req, res) => {
        try {
            ...
            const userToDelete = await Users.findById(targetUserId);
            if (!userToDelete) {
                return res.status(404).json({ message: 'User not found' });
            }
