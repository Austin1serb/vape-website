...
import { Dialog, DialogTitle, DialogContent, Button, Typography, Table, TableBody, TableCell, TableRow } from "@mui/material";
...
const DetailsView: React.FC<Props> = ({ open, product, onClose }) => {
	...
	return (
		<Dialog
			...
			className=""
		>
			<DialogTitle className="bg-primary-variant text-center uppercase h-18">Product Details</DialogTitle>
						...
						<TableBody>
							...
							<TableRow>
								...
								<TableCell>
									{" "}
									{product.imgSource &&
										product.imgSource.map((image, index) => (
											<div
												key={index + "div"}
												className="h-32 w-32 relative mb-2"
											>
												<Image
													key={index}
													src={image.url}
